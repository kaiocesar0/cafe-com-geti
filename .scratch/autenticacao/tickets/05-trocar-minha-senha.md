...
- [ ] Troca da própria senha exige a senha atual e a nova (mínimo 8)
- [ ] Mantém a sessão deste pote e mata as outras da mesma pessoa
- [ ] Senha nova passa a valer no próximo login
- [ ] Senha atual errada falha e o banco/sessões não mudam
- [ ] Acerto na troca zera a trava de login deste navegador nesse username (se existir)
