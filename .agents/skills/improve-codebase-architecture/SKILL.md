...
- **Want to explore alternative interfaces for the deepened module?** Use a design-it-twice approach: spin up parallel sub-agents to draft alternative interfaces, then compare.
